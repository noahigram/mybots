...
We also found that the robots that evolved to move swiftly exhibited movement strategies that are somewhat oscillatory. These robots rely on the patterns of movement that lead them forward the most, and so often an evolved robot would repeat the same movement of its limbs to generate a repetitive move forward. This is a key part of evolution both in our simulations and in nature. Real species, through evolution, develop tactics and strategies that are simply honed and improved across generations, which is almost exactly what we see through our simulations. 
