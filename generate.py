...
def Create_Robot():
    ...
    # Practice with absolute and relative coordinates
    ...
    pyrosim.Send_Joint(name="BackLeg_Torso", parent="BackLeg",
                       child="Torso", type="revolute", position=[0, 0.5, 1])
